...
<html>
  ...
  <body>
       ...
       <table class="columns">
      <tr>
        <td><div class="container" style="margin-left:124px;margin-top:60px">
          <div id="piechart1" style="width: 600px; height: 400px;"></div></div></td>
          <td><div class="container" style="margin-left:124px;margin-top:60px">
          <div id="piechart2" style="width: 600px; height: 400px;"></div></div></tr>
         <tr> <td><div style="padding:15px;"><center><h1 style="color:#001107">SUGGESTIONS</h1></center>
              <style>
                  p
                  {
                      color:#4056a1;
...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart1() {
        var data = google.visualization.arrayToDataTable([
          ['BillPeriod', 'EnergyConsumed in Normal Period', 'Energy Consumed in Peak Hours'],
          <?php
					$con=mysqli_connect('localhost','root','','projectea');
					if(!$con)
					{
                    ...
                    foreach($_POST['checkbox'] as $selected){
                        ...
                        while($row = mysqli_fetch_array($result)){  
                            echo "['BILL:".$row['billperiod']."',".$row['kvah'].",".$row['onpeakkvah']."],";
        ...
        chart.draw(data, options);
         ...
         function drawChart3() {
        var data = google.visualization.arrayToDataTable([
          ['BillPeriod','Contract Demand','kva'],
          <?php
					$con=mysqli_connect('localhost','root','','projectea');
					if(!$con)
					{
                    ...
                    foreach($_POST['checkbox'] as $selected){
                        ...
                        while($row = mysqli_fetch_array($result)){  
                            echo "['BILL:".$row['billperiod']."',".$row['contractdemand'].",".$row['kva']."],";
  ...
  <body> <div class="container-fluid">
      ...
      <center style="padding:42px;">
<table>
    <tr><td><div class="container"id="chart_div1" style="width: 600px; height: 300px; margin-left:20px;"></div></td>
        <td> <div class="container" id="chart_div2" style="width: 600px; height: 300px;margin-left:204px;"></div></td></tr>
    <tr><td style="align:center">  <div class="container"id="chart_div3" style="width: 600px; height: 300px;margin-left:204px;margin-top:78px; "></div></td></tr></table></center>
      
       <div style="padding:75px"><center><h1 style="color:#001107">SUGGESTIONS</h1></center>
              <style>
                  p
                  {
                      color:#4056a1;
  ...
  <body> <div class="container-fluid">
    ...
    <center>  <table class="columns">
      <tr>
        ...
        <div id="columnchart_values3" style="width: 900px; height: 300px;margin-top:200px;"></div></center>
      <br><br>
 <div style="padding:75px"><center><h1 style="color:#001107">SUGGESTIONS</h1></center>
              <style>
                  p
